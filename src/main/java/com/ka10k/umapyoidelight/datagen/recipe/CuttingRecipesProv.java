...
//                        Ingredient.of(CommonTags.Items.TOOLS_KNIFE), ItemRegistration.WHITE_BREAD.get(), 2)
//                .save(output,"umapyoidelight:cutting/bread");
//
//        CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.of(ItemRegistration.WILD_CHILIS.get()),
//                        Ingredient.of(CommonTags.Items.TOOLS_KNIFE), ItemRegistration.CHILI_ITEM.get(), 1)
...
//                        Ingredient.of(CommonTags.Items.TOOLS_KNIFE), ItemRegistration.STRAWBERRY_ITEM.get(), 1)
...
//                        Ingredient.of(CommonTags.Items.TOOLS_KNIFE), ItemRegistration.GARLIC_ITEM.get(), 1)
...
//                        Ingredient.of(CommonTags.Items.TOOLS_KNIFE), ItemRegistration.TRIANGLE_BREAD.get(), 2)
//                .addResult(ItemRegistration.BREAD_CRUST.get())
//                .addResultWithChance(ItemRegistration.BREAD_CRUST.get(), 0.5F)
//                .save(output);
//
//        CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.of(ConventionalItemTags.CARROT_CROPS),
//                        Ingredient.of(CommonTags.Items.TOOLS_KNIFE), ItemRegistration.CUT_CARROT.get(), 2)
//                .addResultWithChance(ItemRegistration.CUT_CARROT.get(), 0.2F)
//                .save(output,"umapyoidelight:cutting/carrot");
//
//        CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.of(ItemRegistration.CUT_CARROT.get()),
//                        Ingredient.of(CommonTags.Items.TOOLS_KNIFE), ItemRegistration.GRATED_CARROT.get(), 1)
...
//                        Ingredient.of(CommonTags.Items.TOOLS_KNIFE), ItemRegistration.CARROT_CAKE_SLICE.get(), 7)
//                .save(output);
//
//        CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.of(ItemRegistration.CARROT_PIE.get()),
//                        Ingredient.of(CommonTags.Items.TOOLS_KNIFE), ItemRegistration.CARROT_PIE_SLICE.get(), 4)
//                .save(output);
//    }
//}
