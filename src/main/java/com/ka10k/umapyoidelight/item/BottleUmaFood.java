...
import static com.ka10k.umapyoidelight.item.ItemRegistration.bottleFood;


public class BottleUmaFood extends ItemFoodBase {
    private final Consumer<LivingEntity> consumer;

    public BottleUmaFood(Consumer<LivingEntity> consumer, FoodInfo info) {
        this(bottleFood(), consumer, info);
    }

    public BottleUmaFood(Item.Properties properties, Consumer<LivingEntity> consumer, FoodInfo info) {
