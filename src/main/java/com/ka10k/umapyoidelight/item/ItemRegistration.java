...
public class ItemRegistration {
    ...
    //blocks
    public static final Supplier<Item> CHILI_CRATE = registerWithTab("chili_pepper_crate",
            () -> new BlockItem(BlockRegistration.CHILI_CRATE.get(),basicItem()));

    public static final Supplier<Item> CHILI_CRATE_RARE = registerWithTab("chili_pepper_crate_rare",
    ...
    public static final Supplier<Item> GARLIC_CRATE_RARE = registerWithTab("garlic_crate_rare",
            () -> new BlockItem(BlockRegistration.GARLIC_CRATE_RARE.get(),basicItem()));

    public static final Supplier<Item> STRAWBERRY_CRATE = registerWithTab("strawberry_crate",
            () -> new BlockItem(BlockRegistration.STRAWBERRY_CRATE.get(),basicItem()));

    public static final Supplier<Item> STRAWBERRY_CRATE_RARE = registerWithTab("strawberry_crate_rare",
            () -> new BlockItem(BlockRegistration.STRAWBERRY_CRATE_RARE.get(),basicItem()));

    public static final Supplier<Item> CARROT_CRATE_RARE = registerWithTab("carrot_crate_rare",
            () -> new BlockItem(BlockRegistration.CARROT_CRATE_RARE.get(),basicItem()));

    public static final Supplier<Item> POTATO_CRATE_RARE = registerWithTab("potato_crate_rare",
            () -> new BlockItem(BlockRegistration.POTATO_CRATE_RARE.get(),basicItem()));

    public static final Supplier<Item> WOODCHIP_BLOCK = registerWithTab("woodchip_block",
            () -> new BlockItem(BlockRegistration.WOODCHIP_BLOCK.get(),basicItem()));

    public static final Supplier<Item> WOODCHIP_ROAD = registerWithTab("woodchip_road",
            () -> new BlockItem(BlockRegistration.WOODCHIP_ROAD.get(),basicItem()));

    public static final Supplier<Item> YAKISOBA_DECO = registerWithTab("gold_ship_yakisoba_deco",
            () -> new BlockItem(BlockRegistration.YAKISOBA_DECO.get(),basicItem()));

    public static final Supplier<Item> COFFEE_DECO = registerWithTab("manhattan_cafe_coffee_deco",
            () -> new BlockItem(BlockRegistration.COFFEE_DECO.get(),basicItem()));

    public static final Supplier<Item> CARROT_HAMBURG_DECO = registerWithTab("carrot_hamburg_deco",
            () -> new BlockItem(BlockRegistration.CARROT_HAMBURG_DECO.get(),basicItem().stacksTo(16)));

    public static final Supplier<Item> CARROT_HAMBURG_DELUXE_DECO = registerWithTab("carrot_hamburg_deluxe_deco",
            () -> new BlockItem(BlockRegistration.CARROT_HAMBURG_DELUXE_DECO.get(),basicItem().stacksTo(16)));

    public static final Supplier<Item> WILD_CHILIS = registerWithTab("wild_chili_peppers",
            () -> new BlockItem(BlockRegistration.WILD_CHILIS.get(),basicItem()));

    public static final Supplier<Item> WILD_GARLIC = registerWithTab("wild_garlic",
            () -> new BlockItem(BlockRegistration.WILD_GARLIC.get(),basicItem()));

    public static final Supplier<Item> WILD_STRAWBERRIES = registerWithTab("wild_strawberries",
    ...
    */
    ...
    public static final Supplier<Item> CARROT_DOUGH =
            registerWithTab("carrot_dough", () -> new ItemFoodBase(basicItem(),FoodInfo.builder()
                    .amountAndCalories(2, 0.3F)
                    .addEffect(() -> new MobEffectInstance(MobEffects.HUNGER, 600, 0), 0.3F)
                    .build()));

    public static final Supplier<Item> CARROT_BREAD =
    ...
    public static final Supplier<Item> RAW_STICK_CARROT =
    ...
    public static final Supplier<Item> RAW_HAMBURG =
    ...
    public static final Supplier<Item> CARROT_POTATO_POTAUFEU_RARE =
    ...
    public static final Supplier<Item> GARLIC_RAMEN =
    ...
    public static final Supplier<Item> GARLIC_RAMEN_RARE =
    ...
    public static final Supplier<Item> POTATO_GARLIC_PIZZA_SLICE =
    ...
    public static final Supplier<Item> POTATO_GARLIC_PIZZA_SLICE_RARE =
    ...
    public static final Supplier<Item> MAPO_CARROT_POTATO =
    ...
    public static final Supplier<Item> MAPO_CARROT_POTATO_RARE =
    ...
    public static final Supplier<Item> CARROT_STRAWBERRY_ICECREAM =
    ...
    public static final Supplier<Item> CARROT_STRAWBERRY_ICECREAM_RARE =
    ...
    public static final Supplier<Item> GI_PLATE =
            registerWithTab("g1_plate", () -> new BowlUmaFood(status -> {
                APRecover(status, CONFIG.AP_RECOVER_G1_PLATE);
            },
    ...
    //misc
    public static final Supplier<Item> COFFEE =
    ...
    public static final Supplier<Item> SAKURAMOCHI =
            registerWithTab("victory_club_rice_cake", () -> new UmaFoodItem(status -> {
                APRecover(status, CONFIG.AP_RECOVER_SAKURAMOCHI);
            },
                    FoodInfo.builder().alwaysEat()
    ...
    public static final Supplier<Item> YAKISOBA =
            registerWithTab("gold_ship_yakisoba", () -> new UmaDrinkItem(status -> {
                APRecover(status, CONFIG.AP_RECOVER_YAKISOBA);
            },
                    FoodInfo.builder().alwaysEat()
    ...
    public static final Supplier<Item> POTION =
    ...
    //placeable meals
    public static final Supplier<Item> RAW_POTATO_GARLIC_PIZZA = registerWithTab("raw_potato_garlic_pizza",
            () -> new Item(basicItem().stacksTo(1)));

    public static final Supplier<Item> RAW_POTATO_GARLIC_PIZZA_RARE = registerWithTab("raw_potato_garlic_pizza_rare",
            () -> new Item(basicItem().stacksTo(1)));

    public static final Supplier<Item> YAKISOBA_PILE = registerWithTab("pile_of_yakisoba",
            () -> new BlockItem(BlockRegistration.YAKISOBA_PILE.get(), basicItem()));

    public static final Supplier<Item> POTATO_GARLIC_PIZZA = registerWithTab("potato_garlic_pizza",
            () -> new PlaceableItem(BlockRegistration.POTATO_GARLIC_PIZZA.get(), basicItem().stacksTo(1)));

    public static final Supplier<Item> POTATO_GARLIC_PIZZA_RARE = registerWithTab("potato_garlic_pizza_rare",
            () -> new PlaceableItem(BlockRegistration.POTATO_GARLIC_PIZZA_RARE.get(), basicItem().stacksTo(1)));

    public static final Supplier<Item> CARROT_CAKE = registerWithTab("carrot_cake",
            () -> new PlaceableItem(BlockRegistration.CARROT_CAKE.get(), basicItem().stacksTo(1)));
